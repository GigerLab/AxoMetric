    ...
    dashboardPage(skin = "black",
                  ...
                  #Total Axon Quantification Tab User Interface
                       tabItem(tabName = 'CTB_Only',
                              fluidPage(
                                ...
                                h6("   a. Select Edit --> Options --> Line Width, set # equal to nerve width (~2500)"),
                                ...
                                h6("4. Select Image --> Adjust --> Brightness_Contrast, adjust signal the same for all images in experiment similar to the example image on this page."),
                                ...
                                h6("2. Enter the number of intervals you want to quantify with."),
                                h6("3. Click the submit button to run the image analysis. Please allow a few minutes for image processing."),
                                h6("4. When finished, you may click the reset button to submit another image for analysis."),
                                h6("*Files may generally take ~30 seconds to process."),
                                br(),
                                fluidRow(column(6, fileInput("file1", "Please upload an 8-bit Tiff Image", accept = c(".tif", ".tiff", "image/tiff")))), 
                                fluidRow(column(2, numericInput("num_intervals", "Number of Intervals:", value = 4, min = 1, step = 1))),
                                fluidRow(column(6, actionButton("submit", "Submit"))),
                                ...
                                h4("Identified Objects with Analysis Intervals"),
                                plotOutput("obj_with_intervals"), # New combined plot
                                h4("Number of Axons"),
                      ...
                      tabItem(tabName = 'CTB_DAPI',
                              fluidPage(
                                ...
                                h6("3. Enter the number of intervals you want to quantify with."),
                                h6("4. Input the height per pixel in inches for the image."),
                                h6("5. Click the submit button to run the image analysis. Please allow a few minutes for image processing."),
                                h6("6. When finished, you may click the reset button to submit another image for analysis."),
                                h6("*Files may generally need ~2 minutes of processing time."),
                                br(),
                                fluidRow(column(6, fileInput("file4", "Please upload an 8-bit Tiff image", multiple = FALSE, accept = c(".tif", ".tiff", "image/tiff")))),
                                fluidRow(column(6, fileInput("file5", "Please upload an 8-bit Tiff image (nuclear staining)", accept = c(".tif", ".tiff", "image/tiff")))),
                                fluidRow(column(2, numericInput("num_intervals_4", "Number of Intervals:", value = 4, min = 1, step = 1))),
                                ...
                                fluidRow(h4("Object Image"),
                                         column(6, h6("Axon Stain"), withSpinner(plotOutput("obj_with_intervals_4"), type = 6)),
                                         column(6, h6("Nuclear Stain"), withSpinner(plotOutput('obj_with_intervals_5'), type = 6)),
                                         style = 'padding:4px;'),
                                h4("Number of Axons"),
                  ...
                  tabItem(tabName = "Multiple_Files",
                              fluidPage(shinyjs::useShinyjs(),
                                        ...
                                        br(),  
                                        fluidRow(column(6, fileInput("list_multiple_files_axon_quantification", "Please upload your images.", multiple = TRUE, accept = c(".tif", ".tiff", "image/tiff")))), 
                                        fluidRow(column(2, numericInput("num_intervals_2", "Number of Intervals:", value = 4, min = 1, step = 1))),
                                        fluidRow(column(6, actionButton("submit_multiple_files", "Submit"))),
                                        h4("Number of Axons"),
                  ...
                  #Total MFI Tab User Interface
                      tabItem(tabName = 'SCG10_Only',
                              fluidPage(
                                ...
                                h6("2. To straighten & crop nerves from injury site to the distal nerve, do the following:"),
                                h6("   a. Select Edit --> Options --> Line Width, set # equal to nerve width (~2500)"),
                                h6("      *For MFI quantification, it is important that this number is optimized to fit the nerve and reduce background that may dilute the overall MFI quantification. If this is a concern, please use the normalization tab to disregard background MFI."),
                                h6("   b. Right-click line tile --> Select segmented line"),
                                h6("   c. Click at nerve crush site, and then click in the middle of the nerve until at distal nerve end, then right-click."),
                                h6("   d. Search for the straighten plugin and then run."),
                                ...
                                br(),
                                fluidRow(column(6, fileInput("file3", "Please upload an 8-bit Tiff Image", accept = c(".tif",'.tiff','image/tiff')))), 
                                fluidRow(column(2, numericInput("num_intervals_3", "Number of Intervals:", value = 4, min = 1, step = 1))),
                                fluidRow(column(6, actionButton("submit_3", "Submit"))),
                                fluidRow(h4("Original Image"), withSpinner(plotOutput("img_3"), type = 6), style = 'padding:4px;'),
                                plotOutput("obj_with_intervals_3"),
                  ...
                  tabItem(tabName = 'SCG10_DAPI',
                              fluidPage(
                                ...
                                h6("4. Select Image --> Scale --> Should be set to 50% (0.5) --> Select OK"),
                                h6("5. Select File --> Save as --> Tiff"),
                                h6("6. Record the pixel height in inches: Select Image --> Properties"),
                                h6("7. Repeat steps 1-5 with an image file of nuclear staining (i.e., DAPI)."),
                                h6("*Please note no nuclear staining can be on the edges of the cropped image or the code may fail to acquire the upper/lower limit of the nerve width."),
                                h6("*Please note that high-quality images are needed for proper quantification (please see example below)."),
                                h6("SCG10 Example"),
                                ...
                                h6("2. Upload nuclear stained tiff image file and wait for upload to complete."),
                                h6("3. Enter the number of intervals you want to quantify with."),
                                h6("4. Input the height of pixels in inches for the image."),
                                h6("5. Click the submit button to run the image analysis. Please allow a few minutes for image processing."),
                                h6("6. When finished, you may click the reset button to submit another image for analysis."),
                                h6("*Files may generally need ~8 minutes of processing time."),
                                br(),
                                fluidRow(column(6, fileInput("file6", "Please upload an 8-bit Tiff image", multiple = TRUE, accept = c('.tif','.tiff','image/tiff')))),
                                fluidRow(column(6, fileInput("file7", "Please upload an 8-bit Tiff image (nucelar staining)", accept = c('.tif','.tiff','image/tiff')))),
                                fluidRow(column(2, numericInput("num_intervals_6", "Number of Intervals:", value = 4, min = 1, step = 1))),
                                ...
                                fluidRow(h4("Interval Quantification"),
                                         column(6,
                                                h6("Stain of Interest"),
                                                withSpinner(plotOutput("obj_with_intervals_6"), type = 6)),
                                         column(6,
                                                h6("Nuclear Stain"),
                                                withSpinner(plotOutput("obj_with_intervals_7"), type = 6))
                                         ),
                  ...
                  tabItem(tabName = "multiple_mfi",
                              fluidPage(shinyjs::useShinyjs(),
                                        ...
                                        h6("   c. Click at nerve crush site, and then click in the middle of the nerve until at distal nerve end, then right-click."),
                                        h6("   d. Search for the straighten plugin and then run."),
                                        h6("   *Make sure background is not present in the cropped image, or this will interfere with the MFI calculation."),
                                        h6("3. Select Image --> Type --> 8-bit"),
                                        h6("4. Select Image --> Scale --> Should be set to 50% (0.5) --> Select OK"),
                                        h6("5. Select File --> Save as --> Tiff"),
                                        h6("*Please note that high-quality images are needed for proper quantification (please see example below)."),
                                        ...
                                        br(), 
                                        fluidRow(column(6, fileInput("list_multiple_mfi", "Please upload your images", multiple = TRUE, accept = c(".tif", ".tiff", "image/tiff")))), 
                                        fluidRow(column(2, numericInput("num_intervals_multi_mfi", "Number of Intervals:", value = 4, min = 1, step = 1))),
                                        fluidRow(column(6, actionButton("submit_multiple_files_mfi", "Submit"))),
                                        h4("Mean MFI"),
                  ...
                  tabItem(tabName = 'Rbpms_Counting',
                              fluidPage(
                                ...
                                br(),
                                fluidRow(column(6, fileInput("file2", "Please upload an 8-bit Tiff Image", accept = c(".tif", ".tiff", "image/tiff")), actionButton("submit_2", "Submit"))),
