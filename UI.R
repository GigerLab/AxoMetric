    ...
    dashboardPage(skin = "black",
                  ...
                  dashboardSidebar(width = 250,
                    sidebarMenu(
                      ...
                      menuItem("MFI Quantification", tabName = 'MFI_Quantification', icon = icon('wand-magic-sparkles', lib='font-awesome'),
                               menuSubItem("Absolute # MFI", tabName = 'SCG10_Only', icon = icon('wand-magic-sparkles', lib='font-awesome')),
                               menuSubItem("Normalized MFI", tabName = 'SCG10_DAPI', icon = icon('wand-magic-sparkles', lib='font-awesome')),
                               menuSubItem("Multiple Files (Absolute # MFI)", tabName = "multiple_mfi", icon = icon('wand-magic-sparkles', lib='font-awesome'))),
                  ...
                  #Total Axon Quantification Tab User Interface
                       tabItem(tabName = 'CTB_Only',
                              fluidPage(
                                ...
                                h6("   a. Select Edit --> Options --> Line Width, set equal to ~2,000"),
                  ...
                  tabItem(tabName = "Multiple_Files",
                              fluidPage(shinyjs::useShinyjs(),
                                        ...
                                        br(),
                                        h4("Image Analysis"),
                                        h6("1. Upload your tiff image files and wait for upload to complete. Please upload image files (select multiple files at once) instead of a folder of files."),
                                        h6("2. Click the submit button to run the image analysis. Please allow a few minutes for image processing."),
                  ...
                  tabItem(tabName = "multiple_mfi",
                              fluidPage(shinyjs::useShinyjs(),
                                        ...
                                        h4("Image Pre-Processing Instructions (to do for each file)"),
                                        h6("1. Open FIJI Software, select File --> Open --> select image file."),
                                        h6("2. Click and drag on the image to create a rectangle selection region to crop the image from injury site to the end of the image. Select Image --> Crop. You may also use the straightening tool to straighten nerve photos and then crop from the injury site to the distal nerve."),
                                        h6("4. Select Image --> Type --> 8-bit"),
                                        h6("3. Select Image --> Adjust --> Brightness_Contrast, adjust maximum value to give optimal signal."),
                                        h6("5. Select File --> Save as --> Tiff"),
                                        h6("*Please note that high-quality images are needed for proper quantification (please see example below)."),
                                        fluidRow(withSpinner(plotOutput("pdf_33"), type = 6), style = 'padding:4px;'),
                                        br(),
                                        h4("Image Analysis"),
                                        h6("1. Upload your tiff image files (select multiple files at once) and wait for upload to complete. Do not upload a folder but just the files."),
                                        h6("2. Click the submit button to run the image analysis. Please allow a few minutes for image processing."),
